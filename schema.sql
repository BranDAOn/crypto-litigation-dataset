...
CREATE TABLE 'filings_fts_config'(k PRIMARY KEY, v) WITHOUT ROWID;;

CREATE TABLE 'filings_fts_content'(id INTEGER PRIMARY KEY, c0, c1);;

CREATE TABLE 'filings_fts_data'(id INTEGER PRIMARY KEY, block BLOB);;

CREATE TABLE 'filings_fts_docsize'(id INTEGER PRIMARY KEY, sz BLOB);;

CREATE TABLE 'filings_fts_idx'(segid, term, pgno, PRIMARY KEY(segid, term)) WITHOUT ROWID;;
